"""
Django settings for broken_scene_41171 project.
...
ROOT_URLCONF = 'broken_scene_41171.urls'
...
WSGI_APPLICATION = 'broken_scene_41171.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_scene_41171 API",
    "DESCRIPTION": "API documentation for broken_scene_41171 App",
    "VERSION": "v1",
}
